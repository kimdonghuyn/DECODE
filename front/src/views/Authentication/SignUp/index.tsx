...
import {ResponseBody, ResponseCode} from "../../../types/enums";
...
export default function SignUp() {
    ...
    const onSignUpButtonClickHandler = () => {
        ...
        const requestBody: SignUpRequestDto = {id, email, password, certificationNumber};
        ...
        <div id='sign-up-wrapper'>
            ...
            <div className='sign-up-container'>
                <div className='sign-up-box'>
                    <div className='sign-up-title'>{'DECODE'}</div>
                    <div className='sign-up-content-box'>
                        ...
                        <div className='sign-up-content-input-box'>
                            <InputBox ref={idRef} title='아이디' placeholder='아이디를 입력해주세요' type='text' value={id}
                                      ...
                                      buttonTitle='중복확인' onButtonClick={onIdButtonClickHandler} onKeyDown={onIdKeyDownHandler}/>
                            <InputBox ref={passwordRef} title='비밀번호' placeholder='비밀번호를 입력해주세요' type='password'
                                      ...
                                      isErrorMessage={isPasswordError} message={passwordMessage} onKeyDown={onPasswordKeyDownHandler}/>
                            ...
                            <InputBox ref={certificationNumberRef} title='인증번호' placeholder='인증번호 4자리를 입력해주세요'
                                      ...
                                      buttonTitle='인증 확인' onButtonClick={onCertificationNumberButtonClickHandler} onKeyDown={onCertificationNumberKeyDownHandler}/>
                        </div>
